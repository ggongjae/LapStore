...
const Recommend = () => {
      ...
      <input type="text" className="text"placeholder="금액 입력" size={10} maxLength={5}/>
       <a> 만원에서  </a>
       <input type="text" className="text"placeholder="금액 입력" size={10} maxLength={5}/>
       <a> 만원까지가 적당해요</a>
      </div>
      ...
      <input type="text" className="contents" placeholder="" size={50} maxLength={5}/>
      </p>
      ...
      <div>
      <br></br> <br></br>
      <Link to='/result'><button className="result"> 결과 확인하기 </button></Link>
      </div>
